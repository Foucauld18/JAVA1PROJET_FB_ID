...
public class Arbitre extends Personne{
    ...
    public void annoncerScoreMatch(Joueur joueur0,Joueur joueur1,int scoreJoueur0, int scoreJoueur1, Joueur vainqueurMatch){
    ...
    public void annoncerScoreSet(Joueur joueur0,Joueur joueur1,int scoreJoueur0, int scoreJoueur1,Joueur vainqueurSet){
    ...
    public void annoncerScoreJeu(String scoreServeur,String scoreJoueur1,String serveur, String joueur1,String vainqueurJeu ){
        System.out.println("------------");
